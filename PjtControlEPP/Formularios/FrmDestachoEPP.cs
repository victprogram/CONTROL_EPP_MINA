...
namespace PjtControlEPP.Formularios
{
    public partial class FrmDestachoEPP : Form
    {
                                ...
                                if (txtobservacion.Text.Length < 230)
                                {
                                    try
                                    {
                                        ...
                                        if (RbNoFactuacion.Checked)
                                        {
                                            ...
                                            //    C.Open();
                                            //    MySqlTransaction tran = C.BeginTransaction();
        ...
        private void BuscarId_Documento()
        {
            ...
            MySqlCommand cmd = new MySqlCommand("select id_tipo_documento,Codigo_Documento,codigo_inventario,nombre_almacen from tipodocumentomina where nombre_documento=@nombre_documento", C);
